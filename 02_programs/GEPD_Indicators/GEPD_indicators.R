...
indicators <- list(
  ...
  c("SE.PRM.INPT.6   ", "100*textbooks", "school", "INPT", "All"),
  c("SE.PRM.INPT.6.R ", "100*textbooks", "school", "INPT", "Rural"),
  c("SE.PRM.INPT.6.U ", "100*textbooks", "school", "INPT", "Urban"),
  c("SE.PRM.INPT.7   ", "100*pens_etc", "school", "INPT", "All"),
  c("SE.PRM.INPT.7.R ", "100*pens_etc", "school", "INPT", "Rural"),
  c("SE.PRM.INPT.7.U ", "100*pens_etc", "school", "INPT", "Urban"),
